...
export const Container = styled.section`
    ...
    transform: translate3d(880px, 52px, 0px);
    display: block;
    ...
    @media only screen and ${device.mobileS} {
        transform: translate3d(80px, 52px, 0px);
    }
    ...
    @media only screen and ${maxDevice.tablet} {
        transform: translate3d(25vw, 10vh, 0px);
    }

    @media only screen and ${device.tabletM} {
        transform: translate3d(57vw, 52px, 0px);
    }

    @media only screen and ${maxDevice.tabletL} {
        transform: translate3d(45vw, 52px, 0px);
    }

    @media only screen and ${device.laptop} {
        transform: translate3d(58vw, 52px, 0px);
    }

    @media only screen and ${device.laptopL} {
        transform: translate3d(61vw, 52px, 0px);
    }

    @media only screen and ${device.desktop} {
        transform: translate3d(70vw, 52px, 0px);
    }

    @media only screen and ${device.desktopL} {
        transform: translate3d(77vw, 6vh, 0px);
    }
`;
